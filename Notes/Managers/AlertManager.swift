...
extension AlertManager {
    public static func failureAddNote(on vc: UIViewController, with error: Error) {
        self.showBasicAlert(on: vc, title: "Failure while adding note", message: "\(error.localizedDescription)")
    }
    
    public static func failureDeleteNote(on vc: UIViewController, with error: Error) {
        self.showBasicAlert(on: vc, title: "Failed to save the note", message: "\(error.localizedDescription)")
    }
    
    public static func failureUpdateNote(on vc: UIViewController, with error: Error) {
        self.showBasicAlert(on: vc, title: "Failed to update the note", message: "\(error.localizedDescription)")
    }
    
    public static func showAlert(title: String, message: String, completion: (() -> Void)? = nil) {
        let alert = UIAlertController(title: title, message: message, preferredStyle: .alert)
